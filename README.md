...
[![Travis Build](https://travis-ci.org/oaago/go-proto-validators.svg)](https://travis-ci.org/oaago/go-proto-validators)
...
```sh
go get github.com/oaago/go-proto-validators/protoc-gen-govalidators
```
